...
assert(notice and notice:find('kalender, 112, Kamper Kiek, Hondenhoek, Column Natuurvereniging', 1, true), 'uitleg over automatische herkenning ontbreekt')
...
assert(notice:find('volledige naam uit Raadspraat/Ondernemen vraagt altijd bevestiging', 1, true), 'persoonsherkenning ontbreekt in de uitleg')
