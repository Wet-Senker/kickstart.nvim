...
assert(exported:find('FOTOBIJSCHRIFT: Een actueel bijschrift', 1, true), 'bijschrift ontbreekt in vormgevingsexport')
assert(exported:find('FOTO: Testfotograaf', 1, true), 'fotocredit ontbreekt in vormgevingsexport')
